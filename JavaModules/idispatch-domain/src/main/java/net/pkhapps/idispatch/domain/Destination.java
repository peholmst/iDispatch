...
import net.pkhapps.idispatch.domain.base.AbstractLockableEntity;
...
public abstract class Destination extends AbstractLockableEntity implements SupportsSoftDelete {
    ...
    public void setResources(Set<Resource> resources) {
        this.resources = Objects.firstNonNull(resources, new HashSet<Resource>());
    }
