...
@CDIView(value = ResourceView.VIEW_ID)
...
public class ResourceView extends AbstractMasterDataView<Resource> {
    ...
    protected void setUpTable(Table table) {
        ...
        table.setConverter("resourceType", new Converter<String, ResourceType>() {
            @Override
            public ResourceType convertToModel(String value, Class<? extends ResourceType> targetType, Locale locale) throws Converter.ConversionException {
                return null; // This is a read-only converter
            }

            @Override
            public String convertToPresentation(ResourceType value, Class<? extends String> targetType, Locale locale) throws Converter.ConversionException {
