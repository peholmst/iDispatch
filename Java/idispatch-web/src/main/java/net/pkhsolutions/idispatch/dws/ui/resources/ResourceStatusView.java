...
@CDIView(value = ResourceStatusView.VIEW_ID)
...
public class ResourceStatusView extends CustomComponent implements View, Refresher.RefreshListener {
    ...
    protected void init() {
        ...
        statusTable.setConverter("resourceState", new Converter<String, ResourceState>() {
            @Override
            public ResourceState convertToModel(String value, Class<? extends ResourceState> targetType, Locale locale) throws Converter.ConversionException {
                return null;
            }

            @Override
            public String convertToPresentation(ResourceState value, Class<? extends String> targetType, Locale locale) throws Converter.ConversionException {
                switch (value) {
                    case ASSIGNED:
    ...
    public static class MenuItemRegistrar {
        ...
        @Inject
        ResourceStatusViewBundle bundle;
