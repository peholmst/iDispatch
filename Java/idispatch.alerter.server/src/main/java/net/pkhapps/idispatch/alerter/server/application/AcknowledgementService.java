...
public interface AcknowledgementService {
    ...
    /**
     * Acknowledges that the given recipient has received the given alert. If more than one acknowledgement is made only
     * the first will be recorded and the rest will be ignored.
     *
     * @param alert     the alert to acknowledge.
     * @param recipient the recipient that is making the acknowledgement.
     */
