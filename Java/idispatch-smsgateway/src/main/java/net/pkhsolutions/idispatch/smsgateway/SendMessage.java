...
public class SendMessage {
    ...
    public void doIt() throws Exception {
        ...
        SerialModemGateway gateway = new SerialModemGateway("modem.com1", "/dev/tty.HUAWEIMobile-Modem", 115200, "Huawei", "");
        ...
        OutboundMessage msg = new OutboundMessage("358408395765", "Hello from SMSLib!");
