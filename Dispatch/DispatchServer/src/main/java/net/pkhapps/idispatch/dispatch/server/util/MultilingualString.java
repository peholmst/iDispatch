...
public interface MultilingualString {
    ...
    /**
     * Creates a new {@link Comparator} that compares two multilingual strings using a specific locale.
     *
     * @param locale the locale to use when comparing.
     * @return a comparator that compares by value using a specific locale.
     */
    static Comparator<MultilingualString> comparingLocale(Locale locale) {
        return Comparator.comparing(o -> o.localizedValue(locale));
    }
